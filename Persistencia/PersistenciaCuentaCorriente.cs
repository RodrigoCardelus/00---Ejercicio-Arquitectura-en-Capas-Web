   ...
   public class PersistenciaCuentaCorriente
    {
       ...
       internal static CuentaCorriente Buscar(int pNumCta)
        {
            SqlConnection _cnn = new SqlConnection(Conexion.Cnn);
        ...
        public static CuentaCorriente BuscarActivos(int pNumCta)
        {
            SqlConnection _cnn = new SqlConnection(Conexion.Cnn);
            CuentaCorriente _unaCta = null;

            SqlCommand _comando = new SqlCommand("CuentaCorrienteBuscarActivo", _cnn);
            _comando.CommandType = System.Data.CommandType.StoredProcedure;
            _comando.Parameters.AddWithValue("@NumCta", pNumCta);
        ...
        public static List<CuentaCorriente> CuentaCorrienteListadoActivos()
        {
            SqlConnection _cnn = new SqlConnection(Conexion.Cnn);
            CuentaCorriente _unaCta = null;
            List<CuentaCorriente> _lista = new List<CuentaCorriente>();

            SqlCommand _comando = new SqlCommand("CuentaCorrienteListadoActivo", _cnn);
            _comando.CommandType = System.Data.CommandType.StoredProcedure;
