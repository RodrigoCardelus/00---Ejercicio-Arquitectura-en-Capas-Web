   ...
   public class PersistenciaCuentaCAhorro
    {
       ...
       internal static CuentaCAhorro Buscar(int pNumCta)
       {
           SqlConnection _cnn = new SqlConnection(Conexion.Cnn);
        ...
        public static CuentaCAhorro BuscarActivos(int pNumCta)
        {
            SqlConnection _cnn = new SqlConnection(Conexion.Cnn);
            CuentaCAhorro _unaCta = null;

            SqlCommand _comando = new SqlCommand("CuentaCAhorroBuscarActivos", _cnn);
            _comando.CommandType = System.Data.CommandType.StoredProcedure;
            _comando.Parameters.AddWithValue("@NumCta", pNumCta);
